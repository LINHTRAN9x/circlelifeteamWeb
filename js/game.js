...
// ============================================================
// HỆ THỐNG ĐẾM LƯỢT XEM TỪNG GAME (Đã fix CORS)
// ============================================================
async function trackGameView(slug) {
  ...
  // URL gốc của máy đếm
  let targetUrl = `https://api.counterapi.dev/v1/clt_game_views/${slug}`;
  if (!hasViewed) {
    targetUrl += '/up'; 
    sessionStorage.setItem(viewKey, 'true');
  }
  
  // Gắn qua trạm trung chuyển (Proxy) để né lỗi CORS
